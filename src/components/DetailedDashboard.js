...
import { ArrowLeft, Building2, User, Shield, Network, Globe, Lock } from 'lucide-react';
import { ContactSection } from './ContactSection';
import { getRegistrarLogoUrl } from '../utils/helpers';

export const DetailedDashboard = ({ domain, onBack }) => {
