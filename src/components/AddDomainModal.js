...
export const AddDomainModal = ({ isOpen, onClose, onAddDomain, token }) => {
  ...
  const handleBulkAdd = async () => {
    ...
    for (const domainName of domains) {
      ...
      try {
        const data = await domainService.getWhoisInfo(domainName);
        ...
        const savedData = await domainService.create(newDomain);
